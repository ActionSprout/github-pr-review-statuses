...
function addActionSproutPRFilterButtons() {
  ...
  if (allASReposButton().length === 0) {
      const newButton = `<a href="/pulls?utf8=✓&q=${actionSproutSearch}" style="border-left: 0px;" aria-label="ActionSprout open pull requests" class="${jsNavItemClass}" role="tab">All Open AS Repos</a>`;
...
function runFunctions() {
  ...
  if (window.location.pathname.indexOf('.com/pulls') > -1) {
